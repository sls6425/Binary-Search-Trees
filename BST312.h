//
// Created by Savannah Schmidt on 11/19/2019.
//
...
void BST_312 <ItemType>::makeEmpty(TreeNode*& t)
{
    ...
    //must delete children nodes before parent
...
void BST_312 <ItemType>::insertItem(TreeNode*& t, const ItemType& newItem)
{
    ...
    //YOUR CODE GOES HERE
    //if the BST is empty to begin with
    if(t == NULL) {
        t = new TreeNode;
        t->data = newItem;
        t->left = NULL;
...
int BST_312 <ItemType>::countNodes(TreeNode* t) const
{
    ...
    //count left subtrees plus right subtrees
